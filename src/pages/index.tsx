  ...
  return (
    <>
      <div className="bg-slate-400 py-20 px-10 grid gap-10 min-h-screen">
        ...
        <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
          ...
          <div className="rounded-3xl p-6 bg-white relative -top-5">
            <div className="flex relative -top-16 items-end justify-between">
              ...
              <div className="h-24 w-24 bg-zinc-500 rounded-full group-hover:bg-red-300 transition-colors" />
              <div className="flex flex-col items-center">
        ...
        <div className="bg-white p-10 rounded-3xl shadow-xl">
          <div className="flex mb-5 justify-between items-center">
            ...
            <div className="space-x-3">
              <span>⭐4.9</span>️
              <span className="shadow-xl p-2 rounded-md">💕</span>️
            </div>
          </div>
        ...
        <form className="flex flex-col space-y-2 bg-blue-500 p-4">
          <input
            type="text"
            required
            placeholder="Username"
            className="required:bg-green-100 invalid:text-red-300"
            minLength={5}
          />
          <input
            type="text"
      ...
      <div className="flex flex-col space-y-2 p-5">
        <details className="select-none open:text-white open:bg-indigo-400">
          ...
          <span className=" selection:bg-blue-500 selection:text-white">
            김치
          </span>
        </details>
        ...
        />
        <p className="first-letter:text-7xl first-letter:hover:text-blue-400">
          lorem asdmlkasdmvklasdmlkvasdlvnaskjvlkasdmlkasdcklmsalkc
        </p>
      </div>
    </>
  );
